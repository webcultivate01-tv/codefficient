        ...
        >
          ...
          >
            ...
            <div className="text-center mb-6">
              <div className="mx-auto w-16 h-16 bg-gradient-to-r from-orange-600 to-yellow-600 hover:shadow-lg rounded-full flex items-center justify-center mb-4 shadow-lg">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 bg-white shadow-sm hover:shadow-md pl-12 placeholder-gray-600"
                  />
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <select
                    name="technology"
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 bg-white shadow-sm hover:shadow-md pl-12 text-gray-700"
                  >
              ...
              <div className="flex items-center justify-between gap-4 pt-6">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3 rounded-lg bg-gradient-to-r from-orange-600 to-yellow-600 hover:shadow-lg focus:ring-4 focus:ring-orange-300 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-200 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02] active:scale-[0.98]"
                >
                  {status === "sending" ? (
